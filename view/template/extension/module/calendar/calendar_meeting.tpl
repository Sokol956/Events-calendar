<div id="meeting-<?php echo $meeting[0]['hall_id'] ?>" class="panel-collapse collapse"></div>
    ...
    <div class="col-lg-3 guests margin-top-10">
        <div id="accordion" class="panel-group">
            <div class="panel panel-default">
                ...
                <div id="guests-<?php echo $meeting[0]['hall_id'] ?>" class="panel-collapse collapse">
                    <div class="panel-body">
                        <?php foreach ($guests as $guest) { ?>
                            <div class="row margin-top-10">
                                <h5 class="col-lg-6 col-sm-6 col-xs-6 margin-top-10"><?php echo $guest["guest_first_name"] ?> <?php echo $guest["guest_second_name"] ?> <?php echo $guest["guest_third_name"] ?></h5>
                                <button class="col-lg-5 col-sm-5 col-xs-5 btn btn-primary btn-sm" data-toggle="modal" data-target="#addGuest">Редактировать</button>
                                <div class="col-lg-1 col-sm-1 col-xs-1"></div>
                            </div>
                        <?php } ?>
                        <button class="col-lg-6 col-sm-6 col-xs-6 margin-top-40 btn btn-primary" data-toggle="modal" data-target="#addGuest">Добавить участника</button>
